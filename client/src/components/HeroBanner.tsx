  ...
  return (
    <section className="relative overflow-hidden rounded-b-2xl">
      ...
      {weddingCountdownDays != null && weddingCountdownDays > 0 ? (
        ...
        >
          <p
            className="text-xs uppercase tracking-[0.18em] text-white sm:text-sm"
            style={{ fontFamily: "var(--font-display)" }}
          >
            Faltam{" "}
            <span className="border-b border-white/70 pb-0.5">{weddingCountdownDays}</span>{" "}
            {weddingCountdownDays === 1 ? "dia" : "dias"} para o seu casamento!
          </p>
        </div>
      ) : null}
    </section>
